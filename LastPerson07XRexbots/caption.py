...
async def set_caption(client: Client, message: Message):
    ...
    await message.reply_text(
        ...
        f"<b>Preview:</b>\n<code>{caption}</code>\n\n"
        "<i>This caption will be applied to your future downloads.\nDEVs: 1. @DmOwner 2. @akaza7902</i>",
        parse_mode=enums.ParseMode.HTML
    )
...
async def see_caption(client: Client, message: Message):
    ...
    if caption:
        await message.reply_text(
            ...
            f"<code>{caption}</code>\n\n"
            "<i>To delete this, use /del_caption\nDEVs: 1. @DmOwner 2. @akaza7902</i>",
            parse_mode=enums.ParseMode.HTML
        )
    else:
        await message.reply_text(
            ...
            "<i>Use /set_caption to customize it.\nDEVs: 1. @DmOwner 2. @akaza7902</i>",
            parse_mode=enums.ParseMode.HTML
        )
...
async def del_caption(client: Client, message: Message):
    ...
    await message.reply_text(
        ...
        "<i>Your uploads will now use the default bot caption.\nDEVs: 1. @DmOwner 2. @akaza7902</i>",
        parse_mode=enums.ParseMode.HTML
    )
