...
async def set_custom_thumbnail(client: Client, message: Message):
    ...
    await message.reply_photo(
        ...
        caption=(
            ...
            "<i>Use /view_thumb to preview • /del_thumb to remove\nDEVs: 1. @DmOwner 2. @akaza7902</i>"
        ),
        parse_mode=enums.ParseMode.HTML
    )
...
async def delete_custom_thumbnail(client: Client, message: Message):
    ...
    if not thumb_id:
        return await message.reply_text(
            "<b>ℹ️ You don't have a custom thumbnail set.\nDEVs: 1. @DmOwner 2. @akaza7902</b>",
            parse_mode=enums.ParseMode.HTML
        )
    ...
    await message.reply_text(
        ...
        "<i>Your uploads will now use the default video/file thumbnail.\nDEVs: 1. @DmOwner 2. @akaza7902</i>",
        parse_mode=enums.ParseMode.HTML
    )
...
async def thumbnail_status(client: Client, message: Message):
    ...
    if thumb_id:
        ...
        extra = "<i>Use /view_thumb to preview\nDEVs: 1. @DmOwner 2. @akaza7902</i>"
    else:
        status = "<b>🔴 No Custom Thumbnail</b>"
        extra = "<i>Use /set_thumb (reply to photo) to enable\nDEVs: 1. @DmOwner 2. @akaza7902</i>"
